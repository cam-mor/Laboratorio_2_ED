 ...
 * @author HP
 */
public class CanchaJugadores extends javax.swing.JFrame {

    /**
     * Creates new form CanchaJugadores
     */
    public CanchaJugadores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/FotoTablero.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CanchaJugadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CanchaJugadores().setVisible(true);
            }
        });
    }
